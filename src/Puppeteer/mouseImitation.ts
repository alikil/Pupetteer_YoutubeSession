...
export class SimulateMouse {
    ...
    public static async frameClick(
        page: puppeteer.Page,
        framesel: string,
        selector: string,
        redirect: Redirect
    ...
    public static async selectTakeRandLinkClick(
        page: puppeteer.Page,
        selector: string,
        redirect: Redirect
    ): Promise<puppeteer.Page> {
    ...
    public static async randomMoves(
        ...
        for (let index = 0; index < count; index++) {
            ...
            await page.mouse.move(randXYZ[0], randXYZ[1], {
                steps: randXYZ[2]
            });
    ...
    public static sleepRand = (min: number, max: number) =>
        new Promise(res => {
